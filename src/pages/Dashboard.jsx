...
const styles = {
  ...
  statCard: { background:"rgba(255,255,255,0.1)", border:"1px solid rgba(255,255,255,0.15)", borderRadius:"12px", padding:"14px 22px", display:"flex", flexDirection:"column", gap:"4px", backdropFilter:"blur(4px)" },
...
const navItems = [
  ...
  { icon:"🗄️", label:"Database",                      page:"database",      color:"indigo" },
];
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.hero}>
        ...
        <h2 style={styles.heroTitle}>Patient Management Azhar</h2>
        <p style={styles.heroSub}>
          Manage patient records, appointments, and clinic data from one central place.
        </p>
        <div style={styles.statsRow}>
          ...
          <div style={styles.statCard}>
            <p style={styles.statNumber}>{stats.todaysAppointments }</p>
            <p style={styles.statLabel}>Today's Appointments</p>
          </div>
          <div style={styles.statCard}>
            <p style={styles.statNumber}>3</p>
            <p style={styles.statLabel}>Doctors On Duty</p>
          </div>
        </div>
      </div>
      ...
      <div style={styles.footer}>
        Family Dental Clinic · Desktop v1.0.0 · Powered by Electron + React
      </div>
    </div>
  );
}